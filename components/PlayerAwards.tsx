              ...
              <div className="flex items-center space-x-4 bg-white/10 backdrop-blur-sm rounded-lg p-4">
                <div className="relative">
                  ...
                  <div className="relative w-20 h-20 rounded-full overflow-hidden border-4 border-white shadow-xl">
                    <Image
                      src={awards.playerOfWeek.playerPhoto || '/player-placeholder.svg'}
                      alt={awards.playerOfWeek.playerName}
                      fill
                ...
                <div className="flex-1">
                  <p className="text-2xl font-bold text-white drop-shadow-md">{awards.playerOfWeek.playerName}</p>
                  <div className="flex items-center space-x-4 mt-2">
                    <div className="bg-white/20 backdrop-blur-sm rounded-lg px-3 py-1">
                      <p className="text-sm text-white/80">Points</p>
                      <p className="text-xl font-bold text-white">{awards.playerOfWeek.totalPoints}</p>
                    </div>
                    <div className="bg-white/20 backdrop-blur-sm rounded-lg px-3 py-1">
                      <p className="text-sm text-white/80">Games</p>
                      <p className="text-xl font-bold text-white">{awards.playerOfWeek.gamesPlayed}</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="bg-gradient-to-br from-purple-500 via-purple-600 to-indigo-600 dark:from-purple-600 dark:via-purple-700 dark:to-indigo-700 rounded-xl shadow-xl p-6 transform transition-all duration-300 hover:scale-105 hover:shadow-2xl animate-fadeInUp" style={{ animationDelay: '0.2s' }}>
            ...
            <div className="flex items-center space-x-4 bg-white/10 backdrop-blur-sm rounded-lg p-4">
              <div className="relative w-16 h-16 rounded-full overflow-hidden border-3 border-white shadow-lg">
                <Image
                  src={awards.playerOfMonth.playerPhoto || '/player-placeholder.svg'}
                  alt={awards.playerOfMonth.playerName}
                  fill
                  className="object-cover"
                />
              </div>
              ...
              <div className="flex-1">
                <p className="text-xl font-bold text-white drop-shadow-md">{awards.playerOfMonth.playerName}</p>
                <div className="flex items-center space-x-3 mt-2">
                  <div className="bg-white/20 backdrop-blur-sm rounded-lg px-2 py-1">
                    <p className="text-xs text-white/80">Points</p>
                    <p className="text-lg font-bold text-white">{awards.playerOfMonth.totalPoints}</p>
                  </div>
                  <div className="bg-white/20 backdrop-blur-sm rounded-lg px-2 py-1">
                    <p className="text-xs text-white/80">Games</p>
                    <p className="text-lg font-bold text-white">{awards.playerOfMonth.gamesPlayed}</p>
                  </div>
                </div>
              </div>
            </div>
