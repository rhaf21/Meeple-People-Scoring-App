              ...
              <div className="space-y-4">
                <div>
                  ...
                  <select
                    ...
                    className="w-full pl-4 pr-10 py-2.5 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 appearance-none bg-no-repeat bg-right"
